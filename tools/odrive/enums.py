...
ODRIVE_ERROR_DUAL_HALL_ILLEGAL_STATE     = 0x00000020
ODRIVE_ERROR_BRAKE_DEADTIME_VIOLATION    = 0x00000040
ODRIVE_ERROR_BRAKE_DUTY_CYCLE_NAN        = 0x00000080
ODRIVE_ERROR_INVALID_BRAKE_RESISTANCE    = 0x00000100
...
class ODriveError(enum.IntFlag):
    ...
    DUAL_HALL_ILLEGAL_STATE                  = 0x00000020
    BRAKE_DEADTIME_VIOLATION                 = 0x00000040
    BRAKE_DUTY_CYCLE_NAN                     = 0x00000080
    INVALID_BRAKE_RESISTANCE                 = 0x00000100
